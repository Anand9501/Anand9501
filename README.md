...
3. [CyPhySS Summit 2023] Presented research work titled "DRAM-MaUT: DRAM Address Mapping Unveiling Tool for ARM Devices" in CyPhySS, India’s largest annual summit on Cyber-Physical Systems (CPS), organized by AI4ICPS at IIT Kharagpur and Robert Bosch Centre for CPS at IISc (20-22 July 2023).
...
1. [VLSID 2024] Participated as a fellowship volunteer at the VLSID’24 conference held at Kolkata.
2. [ICE 2024]  Participated as a Publicity volunteer as well as student liaison in ICE’24 workshop held at Kolkata.
...
## Attended Workshops
 ...
 2. [Internet of Things and Aerial Mess Networks] Two Days Workshop (19-20 Dec 2019) at IIITA.
   ...
   ## Skills
1. Programming Languages ⋄ C, C++, Python, Java, Android
2. Boards ⋄ Raspberry Pi (3B+ and 4B), FPGA (Nexys4 DDR), WINGZ (Gateway Coordinator for IoT devices), Wifimote (Wireless mote with generic sensor interface) and Ubi-Sense(Generic Sensor board), NodeMCU.
3. Software Tools ⋄ Xilinx Vivado, Unity 3D, Blender, Latex, Regard3D (3D Model creation), Hadoop.
4. Communication Skills ⋄ Good reading, writing, and speaking competencies in English, Hindi, and Punjabi.
5. Technical Skills ⋄ Embedded systems, quantitative analysis, academic research, teaching, technical writing, and LATEX typesetting.
6. Soft Skills ⋄ Interpersonal, multitasking, teamwork, decision-making, problem-solving, efficiency, and analytical skills.

 ## Courses Assisted
 
 ⋄ Operating Systems, Data Structure, Internet of Things, Cloud Edge Computing, Embedded Systems and IoT, Introduction to Programming (C), Graph Theory

## Projects Mentored 

⋄ Smart Blind Stick, Door Access Control System With Face Recognition, Weather Monitoring System, Waste Management and Analysis Using Smart Dustbins, Sending and Receiving data from sensor node to Cloud via Wingz Gateway (Edge-Fog-Cloud Setup).
...
registered with Google and displays them on the user’s Android device screen. Searching for a particular entry on the internet and then filtering the results takes a lot of time,
nearby does that all on its own by displaying all businesses close to a user’s location at any time.

Programming Language: Java, Android

## Awards, Honors, and Recognition’s

⋄ Received Travel grant from one of the largest conference in India, VLSID in 2024.

⋄ Received Travel grant from prestigious conference ESWEEK-CASES to travel to Germany in 2023.

⋄ Passed the Graduate Aptitude Test in Engineering in 2017.

⋄ Awardee of a two-year MHRD Fellowship for M.Tech and a five-year PhD Fellowship from 2017.

⋄ Passed the Joint Entrance Examination (Main) in 2013.
